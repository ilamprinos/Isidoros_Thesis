...
export EXCHANGE_USER_ORG=${EXCHANGE_USER_ORG:-issy}   # the name of the org which you will use to create nodes, service, patterns, and deployment policies
...
export MONGO_IMAGE_TAG=${MONGO_IMAGE_TAG:-4.0.18}   # or can be set to stable or a specific version
